...
SECRET_KEY = "django-insecure-z$3(8(hbk_5()7$@6hco#h!wx2#8s5xj6-x=9#&h+-b4v=u_x^"
...
DATABASES = {
    'default': {
        ...
        'HOST': '127.0.0.1',  # matches docker-compose service name
        'PORT': 5432,
    }
}
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",  # matches docker-compose service name
        "OPTIONS": {
